function [] = FeatureCat(varargin)
    ...
    sentiment_lexicons = {...
        ...
        '/mounts/work/philipp/densifier/lexicons/unique/whn_train.txt', ...
    ...
    [pol_SEtrial, dict_SEtrial] = loadTxtFile('/mounts/work/philipp/densifier/lexicons/unique/whn_val.txt');
